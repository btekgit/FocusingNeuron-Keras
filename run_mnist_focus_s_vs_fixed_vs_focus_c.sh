...
# focus-s
nhidden='(784,784)'
ex_name=test_nhidden_fixed_vs_focus_s_784_july_26_2020_focus_s_run                  
...
focus_train_si=True
focus_norm_type=2
ex_name=test_nhidden_fixed_vs_focus_s_784_july_26_2020_focus_c_run
python Kfocusing.py $dset $neuron $cnn_model $nhidden $nfilters $repeats $epochs $batch_size $lr_mul $augment $delay $kn_size $focus_init_sigma\  $focus_init_mu $focus_train_mu $focus_train_si $focus_norm_type $focus_sigma_reg $ex_name
...
ex_name=test_nhidden_fixed_vs_focus_s_784_july_26_2020_fixed_s_run
python Kfocusing.py $dset $neuron $cnn_model $nhidden $nfilters $repeats $epochs $batch_size $lr_mul $augment $delay $kn_size $focus_init_sigma\  $focus_init_mu $focus_train_mu $focus_train_si $focus_norm_type $focus_sigma_reg $ex_name
